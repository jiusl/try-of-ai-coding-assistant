...
import { ToolLoaderLive } from "../tool/loader.js"
...
// EnvLive + FsLive + ToolLoaderLive 合并为一个 infra 层，避免超出 20 层限制
const InfraLive = Layer.mergeAll(EnvLive, FsLive, ToolLoaderLive)
